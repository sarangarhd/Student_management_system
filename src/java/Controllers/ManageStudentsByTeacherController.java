 ...
 * @author rhdsa
 */
@WebServlet(name = "ManageStudentsByTeacherController", urlPatterns = {"/ManageStudentsByTeacherController"})
public class ManageStudentsByTeacherController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ManageStudentsByTeacherController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
